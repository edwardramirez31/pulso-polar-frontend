...
export default function Home() {
  return (
    ...
    <meta name="description" content="Pulso Polar, especialistas en baños de hielo, ofreciendo bienestar y recuperación en Bucaramanga." />

    {/* Meta tags para compartir en redes sociales, como WhatsApp */}
    <meta property="og:title" content="Pulso Polar - Baños de Hielo" />
    <meta name="description" content="Descubre Pulso Polar en Bucaramanga, tu centro especializado en baños de hielo y técnicas de Wim Hof. Experimenta la inmersión en hielo para mejorar tu salud y bienestar."/>

    <meta property="og:url" content="https://www.pulsopolar.com" /> {/* Reemplaza con la URL de tu sitio */}
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://www.pulsopolar.com/icebath8.jpg" /> {/* Reemplaza con la URL de una imagen relevante */}

    {/* Meta tags para mejorar la búsqueda local */}
    <meta name="geo.region" content="CO-SAN" /> {/* Código ISO del departamento de Santander */}
    <meta name="geo.placename" content="Bucaramanga" />
    <meta name="geo.position" content="7.12539;-73.1198" /> {/* Reemplaza con la latitud y longitud de Bucaramanga */}
    <meta name="ICBM" content="7.12539, -73.1198" /> {/* Mismo reemplazo que arriba */}
</Head>
      <div className="bg-white">
    <div className="relative overflow-hidden">
      <header className="relative h-screen">
      <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
            <img src="/icebath8.jpg" alt="Miembro de Pulso Polar dominando el poder del frío" className="w-full h-full object-center object-cover" />
          </div>
