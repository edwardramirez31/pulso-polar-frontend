...
const Benefits = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Sistema Vascular</h3>
                    <p className="mt-5 text-base text-gray-500">Estimula inmediatamente el flujo sanguíneo, reduciendo el ritmo cardíaco y estrés</p>
                  </div>
                </div>
              </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6 9 12.75l4.286-4.286a11.948 11.948 0 0 1 4.306 6.43l.776 2.898m0 0 3.182-5.511m-3.182 5.51-5.511-3.181" />
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Inflamación</h3>
                    <p className="mt-5 text-base text-gray-500">Las bajas temperaturas alivian la inflamación en el cuerpo.</p>
                  </div>
                </div>
              </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0M10.5 8.25h3l-3 4.5h3" />
                    ...
                    <p className="mt-5 text-base text-gray-500">Sincroniza con el ritmo circadiano y ten sueños reparadores y profundos.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Metabolismo</h3>
                    <p className="mt-5 text-base text-gray-500">Eleva tus niveles de atención y enfoque cognitivo para un alto rendimiento.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Resiliencia</h3>
                    <p className="mt-5 text-base text-gray-500">Entrena la mente para aceptar el entorno y manejar el estrés.</p>
                  </div>
                </div>
              </div>
            </div>
