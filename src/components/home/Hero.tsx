                ...
                <div className="mt-4 sm:mt-6">
                    <div className="sm:flex">
                      ...
                      <div className="mt-1 sm:mt-0">
                        <Link href="/experiencias/inmersion-glacial" style={{backgroundColor: '#9cdbd9'}} className="block w-full py-3 px-4 rounded-md shadow bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-medium hover:from-teal-600 hover:to-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-400 focus:ring-offset-gray-900">Quiero vivir la experiencia</Link>
                      </div>
                    </div>
